...
for (const [currency, CurrencyName] of Object.entries(countryList)) {
  ...
  image1.src = `https://flagsapi.com/${countryList2[`${currency}`]}/flat/64.png`;
  image1.alt = `${countryList2[`${currency}`]}`;
  image1.height = '30';

  const image2 = document.createElement("img");
  image2.src = `https://flagsapi.com/${countryList2[`${currency}`]}/flat/64.png`;
  image2.alt = `${countryList2[`${currency}`]}`;
  image2.height = '30';
